...
type RpcGatewayClient interface {
	GetGatewayInfo(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GateWayInfoResponse, error)
}
...
func (c *rpcGatewayClient) GetGatewayInfo(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GateWayInfoResponse, error) {
...
type RpcGatewayServer interface {
	GetGatewayInfo(context.Context, *empty.Empty) (*GateWayInfoResponse, error)
...
func (UnimplementedRpcGatewayServer) GetGatewayInfo(context.Context, *empty.Empty) (*GateWayInfoResponse, error) {
...
func _RpcGateway_GetGatewayInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RpcGatewayServer).GetGatewayInfo(ctx, req.(*empty.Empty))
	}
