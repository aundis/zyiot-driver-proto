...
type ProductCallBackServiceClient interface {
	...
	CreateProductCallback(ctx context.Context, in *CreateProductCallbackRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	// 更新设备回调
	UpdateProductCallback(ctx context.Context, in *UpdateProductCallbackRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	// 删除设备回调
	DeleteProductCallback(ctx context.Context, in *DeleteProductCallbackRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *productCallBackServiceClient) CreateProductCallback(ctx context.Context, in *CreateProductCallbackRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
...
func (c *productCallBackServiceClient) UpdateProductCallback(ctx context.Context, in *UpdateProductCallbackRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
func (c *productCallBackServiceClient) DeleteProductCallback(ctx context.Context, in *DeleteProductCallbackRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
type ProductCallBackServiceServer interface {
	// 创建设备回调 edge c driver s
	CreateProductCallback(context.Context, *CreateProductCallbackRequest) (*empty.Empty, error)
	// 更新设备回调
	UpdateProductCallback(context.Context, *UpdateProductCallbackRequest) (*empty.Empty, error)
	// 删除设备回调
	DeleteProductCallback(context.Context, *DeleteProductCallbackRequest) (*empty.Empty, error)
...
func (UnimplementedProductCallBackServiceServer) CreateProductCallback(context.Context, *CreateProductCallbackRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateProductCallback not implemented")
}
func (UnimplementedProductCallBackServiceServer) UpdateProductCallback(context.Context, *UpdateProductCallbackRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateProductCallback not implemented")
}
func (UnimplementedProductCallBackServiceServer) DeleteProductCallback(context.Context, *DeleteProductCallbackRequest) (*empty.Empty, error) {
