...
var file_cloudinstance_cloudinstance_proto_rawDesc = []byte{
	...
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x75, 0x6e, 0x64, 0x69, 0x73, 0x2f, 0x7a, 0x79, 0x69, 0x6f,
	0x74, 0x2d, 0x64, 0x72, 0x69, 0x76, 0x65, 0x72, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x63,
...
func file_cloudinstance_cloudinstance_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_cloudinstance_cloudinstance_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_cloudinstance_cloudinstance_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_cloudinstance_cloudinstance_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_cloudinstance_cloudinstance_proto_msgTypes[3].Exporter = func(v any, i int) any {
