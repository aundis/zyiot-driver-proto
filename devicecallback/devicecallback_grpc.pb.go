...
type DeviceCallBackServiceClient interface {
	...
	CreateDeviceCallback(ctx context.Context, in *CreateDeviceCallbackRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	// 更新设备回调 edge = c driver = s
	UpdateDeviceCallback(ctx context.Context, in *UpdateDeviceCallbackRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	// 删除设备回调 edge = c driver = s
	DeleteDeviceCallback(ctx context.Context, in *DeleteDeviceCallbackRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *deviceCallBackServiceClient) CreateDeviceCallback(ctx context.Context, in *CreateDeviceCallbackRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
...
func (c *deviceCallBackServiceClient) UpdateDeviceCallback(ctx context.Context, in *UpdateDeviceCallbackRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
func (c *deviceCallBackServiceClient) DeleteDeviceCallback(ctx context.Context, in *DeleteDeviceCallbackRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
type DeviceCallBackServiceServer interface {
	// 创建设备回调 edge = c driver = s
	CreateDeviceCallback(context.Context, *CreateDeviceCallbackRequest) (*empty.Empty, error)
	// 更新设备回调 edge = c driver = s
	UpdateDeviceCallback(context.Context, *UpdateDeviceCallbackRequest) (*empty.Empty, error)
	// 删除设备回调 edge = c driver = s
	DeleteDeviceCallback(context.Context, *DeleteDeviceCallbackRequest) (*empty.Empty, error)
...
func (UnimplementedDeviceCallBackServiceServer) CreateDeviceCallback(context.Context, *CreateDeviceCallbackRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateDeviceCallback not implemented")
}
func (UnimplementedDeviceCallBackServiceServer) UpdateDeviceCallback(context.Context, *UpdateDeviceCallbackRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateDeviceCallback not implemented")
}
func (UnimplementedDeviceCallBackServiceServer) DeleteDeviceCallback(context.Context, *DeleteDeviceCallbackRequest) (*empty.Empty, error) {
