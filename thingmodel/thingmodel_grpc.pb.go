...
type ThingModelDownServiceClient interface {
	ThingModelMsgIssue(ctx context.Context, in *ThingModelIssueMsg, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *thingModelDownServiceClient) ThingModelMsgIssue(ctx context.Context, in *ThingModelIssueMsg, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
type ThingModelDownServiceServer interface {
	ThingModelMsgIssue(context.Context, *ThingModelIssueMsg) (*empty.Empty, error)
...
func (UnimplementedThingModelDownServiceServer) ThingModelMsgIssue(context.Context, *ThingModelIssueMsg) (*empty.Empty, error) {
