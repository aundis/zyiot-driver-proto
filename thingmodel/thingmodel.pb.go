...
var file_thingmodel_thingmodel_proto_rawDesc = []byte{
	...
	0x69, 0x76, 0x65, 0x72, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x74, 0x68, 0x69, 0x6e, 0x67,
...
func file_thingmodel_thingmodel_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_thingmodel_thingmodel_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_thingmodel_thingmodel_proto_msgTypes[1].Exporter = func(v any, i int) any {
