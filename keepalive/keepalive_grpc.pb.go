...
const (
	PingService_Ping_FullMethodName = "/keepalive.PingService/Ping"
)
...
func (c *pingServiceClient) Ping(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*PingResponse, error) {
...
func (UnimplementedPingServiceServer) Ping(context.Context, *empty.Empty) (*PingResponse, error) {
...
var PingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "keepalive.PingService",
	...
	Metadata: "keepalive/keepalive.proto",
}
