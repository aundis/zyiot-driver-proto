...
type CloudInstanceCallBackServiceClient interface {
	...
	CloudInstanceStatueCallback(ctx context.Context, in *CloudInstanceStatueCallbackRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *cloudInstanceCallBackServiceClient) CloudInstanceStatueCallback(ctx context.Context, in *CloudInstanceStatueCallbackRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
...
type CloudInstanceCallBackServiceServer interface {
	// 云实例状态回调 edge = c driver = s
	CloudInstanceStatueCallback(context.Context, *CloudInstanceStatueCallbackRequest) (*empty.Empty, error)
...
func (UnimplementedCloudInstanceCallBackServiceServer) CloudInstanceStatueCallback(context.Context, *CloudInstanceStatueCallbackRequest) (*empty.Empty, error) {
